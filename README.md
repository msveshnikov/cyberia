...
-   redis caching of tiles content
-   in Tile.getChunk() if tile in some position is absent, use random pre-generated landscape element by some nice fractal algorithm